...
(Gabriele Salvato) February 2016 - Modified some #define by inserting CFITSIO_ prefix 
to cope with name clashes with some #define in WinNT.h.
Since they are #defined just as numbers it is not necessary to recompile the library.
*/
...
// (Gabriele Salvato) modified inserting FITSIO_ prefix to cope with a name clash with WinNT.h
// since they are #defined just as numbers it is not necessary to recompile the library
#define CFITSIO_TBIT          1  /* codes for FITS table data types */
#define CFITSIO_TBYTE        11
#define CFITSIO_TSBYTE       12
#define CFITSIO_TLOGICAL     14
#define CFITSIO_TSTRING      16
#define CFITSIO_TUSHORT      20
#define CFITSIO_TSHORT       21
#define CFITSIO_TUINT        30
#define CFITSIO_TINT         31
#define CFITSIO_TULONG       40
#define CFITSIO_TLONG        41
#define CFITSIO_TINT32BIT    41  /* used when returning datatype of a column */
#define CFITSIO_TFLOAT       42
#define CFITSIO_TLONGLONG    81
#define CFITSIO_TDOUBLE      82
#define CFITSIO_TCOMPLEX     83
#define CFITSIO_TDBLCOMPLEX 163
...
// (Gabriele Salvato) modified inserting FITSIO_ prefix to cope with a name clash with WinNT.h
// since they are #defined just as numbers it is not necessary to recompile the library
#define CFITSIO_READONLY  0    /* options when opening a file */
#define CFITSIO_READWRITE 1
// (Gabriele Salvato) end
