...
ADCOMMONDEP := $(ADCOMMONDEP) $(ADPLUGINEDGE)
endif
...
$(ADSIMDETECTOR)_DEPEND_DIRS += $(ADCOMMONDEP)
endif

ifdef ADCSIMDETECTOR
DIRS := $(DIRS) $(ADCSIMDETECTOR)
$(ADCSIMDETECTOR)_DEPEND_DIRS += $(ADCOMMONDEP)
endif

# Build software drivers next (no associated hardware)
ifdef NDDRIVERSTDARRAYS
DIRS := $(DIRS) $(NDDRIVERSTDARRAYS)
$(NDDRIVERSTDARRAYS)_DEPEND_DIRS += $(ADCOMMONDEP)
endif

ifeq ($(WITH_PVA), YES)
  ifdef PVADRIVER
  DIRS := $(DIRS) $(PVADRIVER)
  $(PVADRIVER)_DEPEND_DIRS += $(ADCOMMONDEP)
  endif
endif
...
ifdef ADADSC
DIRS := $(DIRS) $(ADADSC)
$(ADADSC)_DEPEND_DIRS += $(ADCOMMONDEP)
endif

ifdef ADANDOR
DIRS := $(DIRS) $(ADANDOR)
$(ADANDOR)_DEPEND_DIRS += $(ADCOMMONDEP)
endif

ifdef ADANDOR3
DIRS := $(DIRS) $(ADANDOR3)
$(ADANDOR3)_DEPEND_DIRS += $(ADCOMMONDEP)
endif

ifdef ADANDORISTAR
#DIRS := $(DIRS) $(ADANDORISTAR)
#$(ADANDORISTAR)_DEPEND_DIRS += $(ADCOMMONDEP)
endif
...
ifdef ADBRUKER
DIRS := $(DIRS) $(ADBRUKER)
$(ADBRUKER)_DEPEND_DIRS += $(ADCOMMONDEP)
endif

ifdef ADCAMERALINK
DIRS := $(DIRS) $(ADCAMERALINK)
$(ADCAMERALINK)_DEPEND_DIRS += $(ADCOMMONDEP)
endif

ifdef ADDEXELA
DIRS := $(DIRS) $(ADDEXELA)
$(ADDEXELA)_DEPEND_DIRS += $(ADCOMMONDEP)
endif
...
ifdef ADFASTCCD
DIRS := $(DIRS) $(ADFASTCCD)
$(ADFASTCCD)_DEPEND_DIRS += $(ADCOMMONDEP)
endif

ifdef ADFIREWIREWIN
DIRS := $(DIRS) $(ADFIREWIREWIN)
$(ADFIREWIREWIN)_DEPEND_DIRS += $(ADCOMMONDEP)
endif

ifdef ADLAMBDA
DIRS := $(DIRS) $(ADLAMBDA)
$(ADLAMBDA)_DEPEND_DIRS += $(ADCOMMONDEP)
endif

ifdef ADLIGHTFIELD
DIRS := $(DIRS) $(ADLIGHTFIELD)
$(ADLIGHTFIELD)_DEPEND_DIRS += $(ADCOMMONDEP)
endif

ifdef ADMERLIN
DIRS := $(DIRS) $(ADMERLIN)
$(ADMERLIN)_DEPEND_DIRS += $(ADCOMMONDEP)
endif
...
ifdef ADMYTHEN
DIRS := $(DIRS) $(ADMYTHEN)
$(ADMYTHEN)_DEPEND_DIRS += $(ADCOMMONDEP)
endif

ifdef ADPCO
DIRS := $(DIRS) $(ADPCO)
$(ADPCO)_DEPEND_DIRS += $(ADCOMMONDEP)
...
ifdef ADPICAM
DIRS := $(DIRS) $(ADPICAM)
$(ADPICAM)_DEPEND_DIRS += $(ADCOMMONDEP)
endif

ifdef ADPSL
DIRS := $(DIRS) $(ADPSL)
$(ADPSL)_DEPEND_DIRS += $(ADCOMMONDEP)
endif

ifdef ADPERKINELMER
DIRS := $(DIRS) $(ADPERKINELMER)
$(ADPERKINELMER)_DEPEND_DIRS += $(ADCOMMONDEP)
endif

ifdef ADPILATUS
DIRS := $(DIRS) $(ADPILATUS)
$(ADPILATUS)_DEPEND_DIRS += $(ADCOMMONDEP)
endif

ifdef ADPIXIRAD
DIRS := $(DIRS) $(ADPIXIRAD)
$(ADPIXIRAD)_DEPEND_DIRS += $(ADCOMMONDEP)
endif

ifdef ADPOINTGREY
DIRS := $(DIRS) $(ADPOINTGREY)
$(ADPOINTGREY)_DEPEND_DIRS += $(ADCOMMONDEP)
endif

ifdef ADPROSILICA
DIRS := $(DIRS) $(ADPROSILICA)
$(ADPROSILICA)_DEPEND_DIRS += $(ADCOMMONDEP)
endif

ifdef ADPVCAM
DIRS := $(DIRS) $(ADPVCAM)
$(ADPVCAM)_DEPEND_DIRS += $(ADCOMMONDEP)
endif

ifdef ADQIMAGING
DIRS := $(DIRS) $(ADQIMAGING)
$(ADQIMAGING)_DEPEND_DIRS += $(ADCOMMONDEP)
endif

ifdef ADROPER
DIRS := $(DIRS) $(ADROPER)
$(ADROPER)_DEPEND_DIRS += $(ADCOMMONDEP)
endif
...
ifdef ADURL
DIRS := $(DIRS) $(ADURL)
$(ADURL)_DEPEND_DIRS += $(ADCOMMONDEP)
endif

ifdef ADMAR345
DIRS := $(DIRS) $(ADMAR345)
$(ADMAR345)_DEPEND_DIRS += $(ADCOMMONDEP)
endif

ifdef ADMARCCD
DIRS := $(DIRS) $(ADMARCCD)
$(ADMARCCD)_DEPEND_DIRS += $(ADCOMMONDEP)
endif

ifdef ADNED
DIRS := $(DIRS) $(ADNED)
$(ADNED)_DEPEND_DIRS += $(ADCOMMONDEP)
endif

#ifdef ADPYTHON
#DIRS := $(DIRS) $(ADPYTHON)
#$(ADPYTHON)_DEPEND_DIRS += $(ADCOMMONDEP)
#endif
...
$(ARAVISGIGE)_DEPEND_DIRS += $(ADCOMMONDEP)
endif

ifdef FFMPEGVIEWER
DIRS := $(DIRS) $(FFMPEGVIEWER)
$(FFMPEGVIEWER)_DEPEND_DIRS += $(ADCOMMONDEP)
endif

ifdef FIREWIREDCAM
DIRS := $(DIRS) $(FIREWIREDCAM)
$(FIREWIREDCAM)_DEPEND_DIRS += $(ADCOMMONDEP)
endif
