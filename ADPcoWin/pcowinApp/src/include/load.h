...
int (__stdcall *GetAcquireModeEx)(HANDLE ph, WORD* wAcquMode, DWORD* dwNumberImages, DWORD* dwReserved);
int (__stdcall *SetAcquireModeEx)(HANDLE ph, WORD wAcquMode, DWORD dwNumberImages, DWORD* dwReserved);
...
int (__stdcall *SetTransferParameter)(HANDLE ph, PCO_SC2_CL_TRANSFER_PARAM *strTransferParam,int ilen);
int (__stdcall *GetTransferParameter)(HANDLE ph, PCO_SC2_CL_TRANSFER_PARAM *strTransferParam,int ilen);
int (__stdcall *RebootCamera)(HANDLE ph);
int (__stdcall *SetTimeouts)(HANDLE ph, void *buf_in,unsigned int size_in);
int (__stdcall *GetBitAlignment)(HANDLE ph, WORD* wBitAlignment);
int (__stdcall *SetBitAlignment)(HANDLE ph, WORD wBitAlignment);

// PCO Edge specific
int (__stdcall *GetActiveLookupTable)(HANDLE ph, WORD *wIdentifier,WORD* wParameter);
int (__stdcall *SetActiveLookupTable)(HANDLE ph, WORD *wIdentifier,WORD* wParameter);
int (__stdcall *GetLookupTableInfo)(HANDLE ph, WORD wLUTNum, WORD* wNumberOfLuts, char* Description, WORD wDescLen, WORD* wIdentifier, BYTE* bInputWidth, BYTE* bOutputWidth, WORD* wFormat);
int (__stdcall *GetCameraSetup)(HANDLE ph, WORD *wType, DWORD *dwSetup, WORD *wLen);
int (__stdcall *SetCameraSetup)(HANDLE ph, WORD wType, DWORD *dwSetup, WORD wLen);
