...
EXPNETTYPE unsigned int WINAPI GetMinimumNumberInSeries(int *_number);
...
EXPNETTYPE unsigned int WINAPI GetMetaDataInfo(SYSTEMTIME *TimeOfStart,float *_pfTimeFromStart, unsigned int _i_index);
...
EXPNETTYPE unsigned int WINAPI SetDACOutput(int _iOption, int _iResolution, int _iValue);
EXPNETTYPE unsigned int WINAPI SetDACOutputScale(int _iScale);
...
EXPNETTYPE unsigned int WINAPI SetTemperatureEvent(HANDLE event);
...
#define AC_SETFUNCTION_HORIZONTALBIN 4096
#define AC_SETFUNCTION_MULTITRACKHRANGE 8192
#define AC_SETFUNCTION_RANDOMTRACKNOGAPS 16384
#define AC_SETFUNCTION_EMADVANCED 32768
