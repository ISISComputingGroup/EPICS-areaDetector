...
# andorCCDConfig(const char *portName, 
...
#                int priority, 
#                int stackSize)
andorCCDConfig("$(PORT)", "/Programmi/Andor iStar/Drivers", 0, 0, 0, 0, 0)
...
dbLoadRecords("$(ADANDOR)/db/andorCCD.template", "P=$(PREFIX),R=cam1:,PORT=$(PORT),ADDR=0,TIMEOUT=10")
